function [updatedPlayers, ball] = UpdatePlayers(players, ball, timeDelta)
    ...
    for i = 1:nPlayers
        ...
        if indexOfPlayer < 11
        [updatedPlayer, ball] = UpdatePlayer(players, ball, indexOfPlayer, timeDelta, teamBallIndex0, teamGoalIndex0);
        ...
        [updatedPlayer, ball] = UpdatePlayer(players, ball, indexOfPlayer, timeDelta, teamBallIndex1, teamGoalIndex1);
        updatedPlayers{1}(indexOfPlayer,:) = updatedPlayer{1};
        updatedPlayers{2}(indexOfPlayer,:) = updatedPlayer{2};
        updatedPlayers{3}(indexOfPlayer,:) = updatedPlayer{3};
        end
